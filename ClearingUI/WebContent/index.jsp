...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#508ccc">
		...
		<div class="jumbotron jumbotron-fluid" style="background-color:#2A3F54 ">
		  <div class="container">
			<h1 class="display-4 text-center" style="color: #ffffff">Group 5: Clearing and Settlement System</h1>
			<p class="lead text-center" style="color: #ffffff">Implement a multilateral clearing system for settlement of equity trades.</p>
		  </div>
		</div>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-170">
					...
					<div class="text-right p-t-13 p-b-23">
						...
						<a href="passreset.html" class="txt2">
							Username / Password?
						</a>
					</div>
