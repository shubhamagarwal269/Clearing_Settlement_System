		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="signup" method="post">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate = "Please bank account number">
						<input class="input100" type="number" name="bankac" placeholder="Bank Account Number">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-20" data-validate = "Please enter DEMAT account number">
