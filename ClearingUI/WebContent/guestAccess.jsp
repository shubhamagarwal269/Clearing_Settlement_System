        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="guestAccess.jsp" class="site_title"><span>Welcome</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Main <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dashGuest.jsp">Home</a></li> 
                      ...
                      <tbody>
                        <c:forEach var="trade" items="${trades}">
	                        ...
	                        <tr>
							  ...
							  <a style="color:inherit" href="add?tradeId=<c:out value='${trade.tradeId}'/>">
